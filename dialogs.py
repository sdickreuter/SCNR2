...
class StartUp_Dialog(QtWidgets.QDialog):
    ...
    def getOptions(parent=None):
        ...
        result = dialog.exec_()
        return dialog.ui.setup_combobox.currentText(), dialog.ui.stage_checkbox.isChecked(), dialog.ui.cam_checkbox.isChecked(), dialog.ui.rotationmount_checkbox.isChecked(), result == QtWidgets.QDialog.Accepted
